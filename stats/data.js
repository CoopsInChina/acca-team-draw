...
window.ACCA_DATA = {
  ...
  weeks: [
    ...
    { week: 4, date: "2026-09-11", monkeyTeam: "sunshine",
      ...
      bets: {
        roger: { betOn: "Dortmund to beat Paderborn", odds: 1.22, ballsOfSteel: false, result: "win" },
        lincoln: { betOn: "FC Twente to beat Den Haag", odds: 1.22, ballsOfSteel: false, result: "win" },
        lacey: { betOn: "Sparta Prague to beat Jabloned", odds: 1.57, ballsOfSteel: false, result: "win" },
        tim: { betOn: "Porto away at Casa Pia", odds: 1.22, ballsOfSteel: false, result: "win" },
        abby: { betOn: "Swansea to beat Burnley", odds: 2.1, ballsOfSteel: false, result: "win" },
        garry: { betOn: "AZ to beat Willem II", odds: 1.13, ballsOfSteel: false, result: "draw" },
        dewi: { betOn: "Porto away at Casa Pia", odds: 1.22, ballsOfSteel: false, result: "win" },
        mikael: { betOn: "IFK to beat Halmstads BK", odds: 1.42, ballsOfSteel: true, result: "win" },
        steve: { betOn: "Dortmund to beat Paderborn", odds: 1.22, ballsOfSteel: false, result: "win" },
        niblett: { betOn: "Spurs to get a lucky goal", odds: 1.2, ballsOfSteel: true, result: "loss" },
      },
      monkey: {
        expectedReturn: 6.46, seed: "da2b6cc6", poolSize: 9,
        picks: [
          { pick: "AZ Alkmaar", odds: 1.14, result: "draw", league: "Eredivisie" },
          { pick: "Inter Milan", odds: 1.24, result: "win", league: "Serie A" },
          { pick: "Real Madrid", odds: 1.11, result: "win", league: "La Liga" },
          { pick: "Como", odds: 1.22, result: "win", league: "Serie A" },
          { pick: "RB Leipzig", odds: 1.35, result: "win", league: "Bundesliga" },
        ],
      }
    },
